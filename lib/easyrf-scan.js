// easyrf-scan.js — Import de scans de spectre RF (CSV multi-logiciels) en module autonome
// =============================================================================
// Extrait d'EASYRF. Parse les exports de scan de la plupart des logiciels de
...
//   Reporte le niveau mesuré sur une grille de canaux (ex. S.ch d'EASYRF) :
 ...
 * @param {Array<{freq_start:number,freq_end:number}>} channels  ex. EASYRF S.ch
