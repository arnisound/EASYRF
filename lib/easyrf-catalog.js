// easyrf-catalog.js — Base de données micros HF / IEM (France) en module autonome
// =============================================================================
// Extrait d'EASYRF. Catalogue des systèmes HF (micros) et IEM (ears) les plus
...
//            flatten, toMic } from './easyrf-catalog.js';
//
