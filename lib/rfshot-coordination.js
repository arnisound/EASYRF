// rfshot-coordination.js — Algorithme de coordination de fréquences HF
// =============================================================================
// Extrait de RF SHOT. Aucune dépendance, aucun DOM. Calcule des plans de
...
// chaque modèle.
//
//   import { generatePlan, computeIM, assignFrequency } from './rfshot-coordination.js';
//
// Conventions :
//   - fréquences en MHz, espacement (spacing) en kHz ;
//   - un « canal » : { ch, freq_start, freq_end, occupied, ... } (cf. rfshot-tnt) ;
 ...
 * @param {Array} channels  grille de canaux (cf. rfshot-tnt)
 * @param {object} [opts]
